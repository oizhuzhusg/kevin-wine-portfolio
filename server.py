...
PORTFOLIO_TARGETS = [
    ...
    ("Domaine Bruno Clair", "Gevrey-Chambertin 1er Cru Clos du Fonteny", "Burgundy", "red", "2015-2019", "2021", 240, 340, "Discovery", "Ready", "Wishlist", None, None, "已验证风格方向；果味、平衡与结构贴合当前偏好，遇到合适年份可优先单瓶补试。"),
    ...
    ("Domaine Taupenot-Merme", "Charmes-Chambertin Grand Cru", "Burgundy", "red", "2018-2020", "2021", 260, 300, "Discovery", "Hold", "Wishlist", None, None, "只建议单瓶探索；用更完整、带香料感的特级园表达，判断你是否喜欢 Taupenot-Merme 的纯净与结构。"),
    ...
    ("Domaine Duroché", "Gevrey-Chambertin", "Burgundy", "red", "2015-2020", "2021", 180, 260, "Discovery", "Ready", "Wishlist", None, None, "用纯净果味、细致但不失集中度的 Gevrey，继续校准你对结构与中段的偏好。"),
