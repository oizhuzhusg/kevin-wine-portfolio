...
CREATE TABLE IF NOT EXISTS wines (
  ...
  on_order_inventory INTEGER DEFAULT 0,
  storage_unit TEXT,
  storage_shelf INTEGER,
  storage_row TEXT,
  storage_stack TEXT,
...
CREATE TABLE IF NOT EXISTS purchases (
  ...
  total_cost REAL,
  fulfillment_status TEXT NOT NULL DEFAULT 'delivered' CHECK (fulfillment_status IN ('ordered','delivered')),
